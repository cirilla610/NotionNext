...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '希望的影像b-side', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://asecarc.top/', // 网站地址
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12201860718', // 对应歌单的 id
